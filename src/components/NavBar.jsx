...
const Nav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`bg-gray-100 text-3xl border-gray-300 border z-30 gap-4 transition-all md:mt-32 duration-500 ease-in text-white md:w-[${maxWidth}] max-w-[${maxWidthMobile}] md:min-w-[200px] cursor-pointer ps-1 fixed top-0 right-0 transform ${
